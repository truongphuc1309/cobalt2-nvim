...
function M.get(c, opts)
  ...
  return {
    ...
    MoreMsg                     = { fg = c.yellow }, -- |more-prompt|
    ...
    TabLineSel                  = { fg = c.black, bg = c.yellow }, -- tab pages line, active tab page label
    ...
    Type                        = { fg = c.purple, italic = true }, -- (preferred) int, long, char, etc.
    ...
    helpCommand                 = { bg = c.terminal_black, fg = c.yellow },
